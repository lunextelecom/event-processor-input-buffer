...
public class InputProcessorHttpSnoopClient {
    ...
    public InputProcessorHttpSnoopClient(String url,
    ...
    public void postRequestJsonContent(JSONObject jsonObject, boolean async)
	    throws Exception {
	try {
	...
	try {
	    ...
	    b.group(group)
		    ...
		    .handler(
			    new InputProcessorHttpSnoopClientInitializer(
				    sslCtx, callback));
		...
		bodyRequestEncoder.addBodyAttribute(key, jsonObject.get(key)
			.toString());
	    }
